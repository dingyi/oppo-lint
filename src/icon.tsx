...
const Icon = ({ type, className }: Props) => {
  if (type === 'FONTS') return <img src={fonts} className={className} />
  if (type === 'LAYERS') return <img src={layers} className={className} />
  ...
  if (type === 'COMPONENT') return <img src={component} className={className} />
  if (type === 'INSTANCE') return <img src={instance} className={className} />
  if (type === 'BOOLEAN_OPERATION') return <img src={booleanOp} className={className} />
  ...
  if (type === 'RECTANGLE') return <img src={rectangle} className={className} />
